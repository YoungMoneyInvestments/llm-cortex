...
Supports two embedding providers:
  - "local" (default): BAAI/bge-m3 (1024 dims, free)
...
EMBEDDING_DIM = _PROVIDER_DIMS.get(EMBEDDING_PROVIDER, 1024)
EMBEDDING_MODEL = "text-embedding-3-small"  # OpenAI model name
LOCAL_EMBEDDING_MODEL = os.environ.get("CORTEX_LOCAL_MODEL", "BAAI/bge-m3")
...
def _cli_backfill(args):
    ...
    # Estimate time
    est_rate = 50  # conservative docs/sec for bge-m3 on CPU
