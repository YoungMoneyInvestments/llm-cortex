...
# Lazy-loaded sentence-transformer model for message search (1024-dim, BAAI/bge-m3)
_ST_MODEL = None
_ST_MODEL_NAME = os.environ.get("CORTEX_LOCAL_MODEL", "BAAI/bge-m3")
...
def handle_tool_call(name: str, arguments: dict) -> dict:
    ...
    try:
        ...
        if name == "cami_memory_search":
            ...
            # Embed query using sentence-transformers (BAAI/bge-m3, 1024-dim by default)
