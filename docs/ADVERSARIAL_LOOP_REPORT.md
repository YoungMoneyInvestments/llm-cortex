...
**Status:** Deferred  
**Description:** Details removed — concerns a proprietary, patent-pending module maintained
...
### RISK-4 — Proprietary module excluded from version control

**Passes:** C2, D2  
**Decision:** Accepted — patent-pending confidentiality requirement  
**Description:** A proprietary, patent-pending module is intentionally excluded from this
repository, so its changes are not tracked here, cannot be diffed, and cannot be included
in CI test runs.  
...
### Priority 5 — Address DEF-1 and DEF-2

**Effort:** 2-4 hours each  
**Constraint:** Concerns a proprietary, patent-pending module maintained outside this
repository; details removed.  
**Why fifth:** Neither is a current correctness bug.
